...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(db_index=True, help_text='format: required, max-255', max_length=255, unique=True, verbose_name='name')),
                ...
                ('alt_text', models.CharField(blank=True, help_text='Please add alternative text (Optional):', max_length=255, null=True, verbose_name='Alternative text')),
